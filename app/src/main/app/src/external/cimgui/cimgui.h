...
#else
CIMGUI_API void igImplAndroid_Shutdown(void);
CIMGUI_API void igImplAndroid_NewFrame(void);
CIMGUI_API bool igImplAndroid_Init(ANativeWindow* window);
CIMGUI_API int32_t igImplAndroid_HandleInputEvent(const AInputEvent* input_event);
#endif
